...
.load_con { background: url(../images/bg_noti.gif) no-repeat left top; width: 539px; height: 436px; padding: 135px 96px 0 96px; position: absolute; left: 50%; top: 50%; margin-left: -365px; margin-top: -285px; border: 1px solid #e1e1e1;}
...
<!-- 
document.onkeydown = doNotReloadCommon;
...
<body style="background: none;">
	...
	<div id="roundBox_loading" class="load_con">
		...
		<div class="box">
			<img src="../images/noti.gif" alt="" style="margin-top: 13px;" width="40" /> <br/>
			<p>잘못된 접근 입니다. 잠시후 메인 페이지로 이동합니다.</p>				
		</div>

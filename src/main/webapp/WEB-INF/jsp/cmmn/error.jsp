...
.load_con { background: background: url(images/bg_noti.gif), url(../images/bg_noti.gif) no-repeat left top; width: 539px; height: 436px; padding: 135px 96px 0 96px; position: absolute; left: 50%; top: 50%; margin-left: -365px; margin-top: -285px; border: 1px solid #e1e1e1;}
...
<body style="background: none;">
	...
	<div id="roundBox_loading" class="load_con">
		...
		<div class="box">
			...
			<p>홈페이지 점검중입니다<br/>
2016년 8월 29일 22:00 ~ 2016년 8월 29일 21:00</p>				
		</div>

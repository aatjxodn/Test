...
/* 	$(function(){
		$('#password').keyup(function(){
			$('#th_html').html('비밀번호는 영문자+숫자+특수문자<br> 조합으로 8~25자리 사용해야 합니다.');
			$('#th_html').css('color', 'gray');
			$('#th_html').css('font-size', '7px');   	      
		});
	...
	$(function(){
	    ...
	    $('#repassword').keyup(function(){
	        ...
	        if($('#password').val() != $('#repassword').val()){
	          ...
	          $('#th_html2').css('color', '#FFCECE');
	        } else{
	          $('#th_html2').html('비밀번호가 일치합니다.');
	          $('#th_html2').css('color', 'aqua');
	        }
	...
	$(document).ready(function(){
		...
		$('#password').on('click', function(){
			$('#th_html1').html('비밀번호는 영문자+숫자+특수문자<br>조합으로 8~25자리 사용해야 합니다.');
			$("#th_html1").css('font-size', '10px');
			$("#th_html1").css('color', 'gray');
			$("#th_html0").html('');
			$("#th_html3").html('');
			$("#th_html4").html('');
			$("#th_html5").html('');
...
<div id="layout1">
	<div id="container1">
		<form name="join_form" action="signUp.do" method="post">
			<table style="display: block; border: 1px solid black; padding: 25px; border-radius: 10px;">
				<tr>
					<th>아이디</th>
					<th><input type="text" name="id" id="id" placeholder="아이디"><input type="button" value="중복체크" id="idck" onclick="id_idck()" style="margin-left: 15px;"></th>
				</tr>
				<tr>
				...
				<tr>
					<th>전화번호</th>
					<th><input type="text" name="phone" id="phone" oninput="autoHyphen2(this)" maxlength="13" placeholder="전화번호를 입력하세요."></th>
				</tr>
				<tr>
					<th><div style="display: none;"></div></th>
					<th id="th_html4"></th>
				...
				<tr>
					<th>약관동의</th>
					<th><input type="checkbox" value="Y" name="agree" id="agree">약관에 동의합니다.</th>
				</tr>
				<tr>
